        ...
        <ul>
          ...
          <li className=''>
            <button type='button' aria-label='notiButton' className='notiButton' data-attribute-id='gnb' data-gnb-kind='bell'>
              <svg xmlns='https://www.w3.org/2000/svg' xmlnsXlink='https://www.w3.org/1999/xlink'
                ...
                <g fill='none' fillRule='evenodd'>
                  <g transform='translate(-1079, -16) translate(224, 7) translate(855, 9)'>
                    <mask id='1dencd96ob' fill='#fff'>
                      <use xmlnsXlink='#bpnpn3yn0a'></use>
                    </mask>
                    <use fillRule='nonzero' stroke='currentColor' strokeWidth='.3' xlinkHref='#bpnpn3yn0a'></use>
                    <g fill='currentColor' mask='url(#1dencd96ob)'><path d='M0 0H18V18H0z'></path>
                      </g></g></g>
              </svg>
            </button>
          </li>
